...
<body id="page-top">
            ...
            <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-md-3 justify-content-center">
                ...
                <div class="col mb-5">
                    <div class="card h-100 animated">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-left">
                                <a class="btn btn-primary mt-auto" href="https://labadibeachhotelgh.com/hotel/">Book
                                    Now</a>
                            </div>
                            <div class="text-left">
                                <a class="btn btn-outline-dark mt-auto" href="https://labadibeachhotelgh.com/">View
                                    Details</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col mb-5">
                    <div class="card h-100 animated">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-left">
                                <a class="btn btn-primary mt-auto" href="https://royalsenchi.reserve-online.net/">Book
                                    Now</a>
                            </div>
                            <div class="text-left">
                                <a class="btn btn-outline-dark mt-auto" href="https://www.theroyalsenchi.com/">View
                                    Details</a>
                            </div>
                        </div>
                    </div>
    ...
    <!--Festured hotel Hotels Section -->
    <section class="py-5 bg-light top-hotels">
        <div class="container px-4 px-lg-5 mt-5">
            <h2 class="fw-bolder mb-4">Featured Hotels</h2>
            <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-md-3 justify-content-center">
                <div class="col mb-5">
                    <div class="card h-100 animated">
                        <!-- Hotel image -->
                        <img class="card-img-top" src="images/pee1.jpg" alt="..." />
                        <!-- Hotel features -->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <h5 class="fw-bolder mb-3">Peemary's Hotel</h5>
                                <div class="d-flex flex-column justify-content-end align-items-start mb-3">
                                    <div>
                                        <i class="fas fa-wifi me-2"></i>
                                        <span>Free Wi-Fi</span>
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-left">
                                <a class="btn btn-primary mt-auto" href="https://www.peemaryshotel.com/en/reservation"
                                    target="_blank">Book Now</a>
                            </div>
                            <div class="text-left">
                                <a class="btn btn-outline-dark mt-auto" href="https://www.peemaryshotel.com/en/"
                                    target="_blank">View Details</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col mb-5">
                    <div class="card h-100 animated">
                        <!-- Hotel image -->
                        <img class="card-img-top" src="images/gy1.jpg" alt="..." />
                        <!-- Hotel features -->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <h5 class="fw-bolder mb-3">Gyamfua Court Apartment</h5>
                                <div class="d-flex flex-column justify-content-end align-items-start mb-3">
                                    <div>
                                        <i class="fas fa-wifi me-2"></i>
                                        <span>Free Wi-Fi</span>
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-left">
                                <a class="btn btn-primary mt-auto"
                                    href="https://www.gyamfuaa-apartments.com/bookings#/search" target="_blank">Book
                                    Now</a>
                            </div>
                            <div class="text-left">
                                <a class="btn btn-outline-dark mt-auto" href="https://www.gyamfuaa-apartments.com/"
                                    target="_blank">View Details</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col mb-5">
                    <div class="card h-100 animated">
                        <!-- Hotel image -->
                        <img class="card-img-top" src="images/ali1.jpg" alt="..." />
                        <!-- Hotel features -->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <h5 class="fw-bolder mb-3">Alisa Hotel</h5>
                                <div class="d-flex flex-column justify-content-end align-items-start mb-3">
                                    <div>
                                        <i class="fas fa-wifi me-2"></i>
                                        <span>Free Wi-Fi</span>
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-left">
                                <a class="btn btn-primary mt-auto"
                                    href="https://live.ipms247.com/booking/book-rooms-alisahotels" target="_blank">Book
                                    Now</a>
                            </div>
                            <div class="text-left">
                                <a class="btn btn-outline-dark mt-auto" href="https://m.alisahotels.com/"
                                    target="_blank">View Details</a>
                            </div>
                        </div>
                    </div>
